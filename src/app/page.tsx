      ...
      <div className="mx-auto w-[80%]">
        ...
        <section className="relative overflow-hidden bg-chicago-navy">
          ...
          <div className="hero-parallax-bg absolute inset-0 -z-10" aria-hidden="true">
            <div className="absolute -top-32 -left-32 h-96 w-96 rounded-full bg-chicago-blue/15 blur-3xl" />
            <div className="absolute top-1/4 right-0 h-96 w-96 rounded-full bg-chicago-red/15 blur-3xl" />
          ...
          <div className="px-6 pb-64 pt-16">
            ...
            <div className="grid grid-cols-1 items-end gap-12 lg:grid-cols-5">
              <div className="lg:col-span-3">
                <p className="mb-6 inline-flex items-center rounded-full border border-white/20 bg-white/5 px-3 py-1 font-semibold text-[11px] tracking-[0.2em] text-white/70 uppercase">
              ...
              <div className="lg:col-span-2 lg:pb-3">
                <p className="mb-8 text-lg leading-relaxed text-white/80">
                  Ranked-choice, STV, approval, and yes/no. Anonymous ballots, cryptographic
                  receipts, full audit trails. Self-host in one container.
                </p>
        ...
        <section
          id="methods"
          className="relative z-10 -mt-48 scroll-mt-24 rounded-t-[2.5rem] bg-surface-warm pb-24 pt-20 shadow-[0_-20px_60px_rgba(0,0,0,0.1)]"
        >
          <div className="px-6">
