...
export default function DeletePollButton({ slug, title }: Props) {
  ...
  async function handleDelete() {
    ...
    const res = await fetch(`/api/polls/${slug}`, { method: 'DELETE' })
    ...
    return (
      <div className="rounded-xl border-2 border-red-200 bg-red-50 p-6">
        ...
        <p className="mt-0.5 text-xs text-red-700">
          This will permanently remove the poll and all associated data. This cannot be undone.
        </p>
