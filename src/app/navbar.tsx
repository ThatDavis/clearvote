    ...
    <nav className="sticky top-0 z-40 mx-auto w-[80%] rounded-b-2xl bg-white/80 shadow-md backdrop-blur-sm">
      <div className="flex items-center justify-between px-6 py-3 sm:px-8">
        ...
        <div className="hidden items-center gap-7 text-sm md:flex">
          <Link
            href="/#methods"
            className="text-zinc-500 transition-colors hover:text-chicago-navy"
          >
            Methods
          </Link>
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 text-zinc-500 transition-colors hover:text-chicago-navy"
          >
