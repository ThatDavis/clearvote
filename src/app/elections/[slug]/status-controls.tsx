...
export default function ElectionStatusControls({ slug, status }: Props) {
        ...
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-0.5 text-xs text-green-700">
              Opening the election locks the voter roll and allows ballots to be cast.
            </p>
          </div>
          <button
            type="button"
  ...
  if (status === 'open') {
    return (
      <div className="rounded-xl border-2 border-red-200 bg-red-50 p-6">
        <div className="flex items-center justify-between gap-4">
          <div>
            <p className="text-sm font-semibold text-red-900">Close this election?</p>
